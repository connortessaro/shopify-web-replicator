...
Use the local operator console to turn a reference URL into deterministic Shopify theme output and a store setup plan, then review both in the theme workspace before any store preview or publish step.
...
7. Verify the generated theme for layout parity, content structure, planned merchandising setup, CTA behavior, and native Shopify checkout handoff.
...
- The generator writes the stable generated section and template outputs for the selected page type plus a deterministic store setup plan artifact.
