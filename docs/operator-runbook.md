...
Use the local operator console to turn a reference URL into deterministic Shopify theme output, a store setup plan, a commerce wiring plan, and an integration report, then review all four in the theme workspace before any store preview or publish step.
...
5. Open the job-scoped handoff page and review:
   ...
   - integration report checks covering generated artifact consistency and commerce snippet wiring
...
10. Use the generated `config/generated-integration-report.json` report to confirm the theme, store setup, and commerce outputs still line up before preview or publish.
